...
class Infer_CT_Dataset(Dataset):
    def __init__(self, fold_path, dataset_type, transform=None, torch_type="float", data_type="dicom", infer=True):
    ...
    def _loader(self, idx):
        ...
        input_np = min_max_normalization(img[:, 512*0: 512*1], min_new=-1.0, max_new=1.0)
